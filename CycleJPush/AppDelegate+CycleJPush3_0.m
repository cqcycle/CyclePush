...
#import "AppDelegate+CycleJPush3_0.h"
...
@implementation AppDelegate (CycleJPush3_0)
...
//    
//    NSString *nowtime = [sdf stringFromDate:time];
//    NSLog(@"接收消息的时间：%@",nowtime);
//    ///内容
//    NSLog(@"strArray====:::  [ %@ ]",str);
//    NSMutableDictionary *mutDict = [dic mutableCopy];
//    [mutDict setObject:nowtime forKey:@"nowtime"];
//    
//    NSLog(@"mutDict:%@");
//    
//    [datasource addObject:mutDict];
//    [CycleJpush3 cycleArchivePushMessages:datasource];
